...
import {
  DashboardOutlined,
  LogoutOutlined,
  BlockOutlined, // Un ícono para "Cultivos"
  CalendarOutlined, // Un ícono para "Cosechas"
  MenuFoldOutlined,
  MenuUnfoldOutlined,
...
/**
 * Layout: layouts/Usuarios/Agricultores/AgricultorLayout.tsx
 * * Este es el layout principal para la sección de Agricultores.
  ...
  const menuItems = [
    {
      ...
      label: <Link to="/agricultor">Panel Principal</Link>,
    },
    {
      key: '2',
      icon: <BlockOutlined />,
      label: <Link to="/agricultor/mis-cultivos">Mis Cultivos</Link>, // Ruta de ejemplo
    },
    {
      key: '3',
      icon: <CalendarOutlined />,
      label: <Link to="/agricultor/cosechas">Cosechas</Link>, // Ruta de ejemplo
    },
  ];
  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Layout style={{ marginLeft: collapsed ? 80 : 200, transition: 'margin-left 0.2s' }}>
        ...
        >
          {/* Aquí es donde React Router renderizará la vista (ej: Agricultores.tsx) */}
          <Outlet />
        </Content>
