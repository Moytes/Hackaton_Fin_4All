...
/**
 * Vista: src/view/Usuarios/Distribuidores
...
const Distribuidores: React.FC = () => {
  ...
  return (
    <Card>
      <Title level={2}>Panel de Distribuidor</Title>
      ...
      <Space wrap className="mt-6">
        {/* Quitamos el botón "Volver al Panel Admin".
          Este es el panel principal del Distribuidor.
          La navegación principal debe estar en el DistribuidorLayout.
        */}
